...
PRINT_FREQ = 200  # frequency of print loss and accuracy at training step
VAL_FREQ = 1000  # frequency of model eval on validation dataset
SAVE_FREQ = 2000  # frequency of saving model
TEST_SIZE = 200  # fixed
...
def Test_phase(model, args, k):
    ...
    for i in range(TEST_SIZE):
        for episode in test_loader:
            ...
            proto = proto.reshape(args.nway, args.kshot, -1).mean(dim=1)
